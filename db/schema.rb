...
ActiveRecord::Schema.define(version: 2018_06_24_101208) do

  create_table "admin_user_pages", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "section_edits", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
